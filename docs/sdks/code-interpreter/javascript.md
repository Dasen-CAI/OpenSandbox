---
title: Code Interpreter JavaScript SDK
description: TypeScript/JavaScript SDK for executing code in secure, isolated OpenSandbox environments with multi-language support.
---

# OpenSandbox Code Interpreter SDK for JavaScript/TypeScript
